...
import (
    ...
    idb94c4e220b49cc1749fa9741500cbf99275f162e482503103c0c383fd7e491f "github.com/octokit/go-sdk-enterprise-cloud/pkg/github/users/item/starred"
)
...
type ItemStarredRequestBuilderGetQueryParameters struct {
    ...
    Direction *idb94c4e220b49cc1749fa9741500cbf99275f162e482503103c0c383fd7e491f.GetDirectionQueryParameterType `uriparametername:"direction"`
    // The page number of the results to fetch. For more information, see "[Using pagination in the REST API](https://docs.github.com/enterprise-cloud@latest//rest/using-the-rest-api/using-pagination-in-the-rest-api)."
    Page *int32 `uriparametername:"page"`
    // The number of results per page (max 100). For more information, see "[Using pagination in the REST API](https://docs.github.com/enterprise-cloud@latest//rest/using-the-rest-api/using-pagination-in-the-rest-api)."
    Per_page *int32 `uriparametername:"per_page"`
    // The property to sort the results by. `created` means when the repository was starred. `updated` means when the repository was last pushed to.
    Sort *idb94c4e220b49cc1749fa9741500cbf99275f162e482503103c0c383fd7e491f.GetSortQueryParameterType `uriparametername:"sort"`
}
