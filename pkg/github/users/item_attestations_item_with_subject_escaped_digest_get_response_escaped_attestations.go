...
type ItemAttestationsItemWithSubject_digestGetResponse_attestations struct {
    ...
    bundle i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.SigstoreBundle0able
...
func (m *ItemAttestationsItemWithSubject_digestGetResponse_attestations) GetBundle()(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.SigstoreBundle0able) {
    return m.bundle
}
...
func (m *ItemAttestationsItemWithSubject_digestGetResponse_attestations) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["bundle"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CreateSigstoreBundle0FromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetBundle(val.(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.SigstoreBundle0able))
        }
        return nil
    }
...
func (m *ItemAttestationsItemWithSubject_digestGetResponse_attestations) SetBundle(value i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.SigstoreBundle0able)() {
    m.bundle = value
}
...
type ItemAttestationsItemWithSubject_digestGetResponse_attestationsable interface {
    ...
    GetBundle()(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.SigstoreBundle0able)
    GetBundleUrl()(*string)
    GetRepositoryId()(*int32)
    SetBundle(value i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.SigstoreBundle0able)()
