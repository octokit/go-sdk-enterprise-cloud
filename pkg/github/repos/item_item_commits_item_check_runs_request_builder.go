...
import (
    ...
    ica58dcd957bfdfd2e65fe1269306e6a2c95c0c80e331b8e2b81f5e93d575f659 "github.com/octokit/go-sdk-enterprise-cloud/pkg/github/repos/item/item/commits/item/checkruns"
)
...
type ItemItemCommitsItemCheckRunsRequestBuilderGetQueryParameters struct {
    ...
    Filter *ica58dcd957bfdfd2e65fe1269306e6a2c95c0c80e331b8e2b81f5e93d575f659.GetFilterQueryParameterType `uriparametername:"filter"`
    // The page number of the results to fetch. For more information, see "[Using pagination in the REST API](https://docs.github.com/enterprise-cloud@latest//rest/using-the-rest-api/using-pagination-in-the-rest-api)."
    Page *int32 `uriparametername:"page"`
    // The number of results per page (max 100). For more information, see "[Using pagination in the REST API](https://docs.github.com/enterprise-cloud@latest//rest/using-the-rest-api/using-pagination-in-the-rest-api)."
    Per_page *int32 `uriparametername:"per_page"`
    // Returns check runs with the specified `status`.
    Status *ica58dcd957bfdfd2e65fe1269306e6a2c95c0c80e331b8e2b81f5e93d575f659.GetStatusQueryParameterType `uriparametername:"status"`
}
