...
// ByProtection_rule_id gets an item from the github.com/octokit/go-sdk-enterprise-cloud/pkg/github.repos.item.item.environments.item.deployment_protection_rules.item collection
