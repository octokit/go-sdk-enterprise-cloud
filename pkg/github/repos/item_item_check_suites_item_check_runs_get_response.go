...
type ItemItemCheckSuitesItemCheckRunsGetResponse struct {
    ...
    check_runs []i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CheckRunable
...
func (m *ItemItemCheckSuitesItemCheckRunsGetResponse) GetCheckRuns()([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CheckRunable) {
    return m.check_runs
}
...
func (m *ItemItemCheckSuitesItemCheckRunsGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["check_runs"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CreateCheckRunFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CheckRunable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CheckRunable)
                }
            }
            m.SetCheckRuns(res)
        }
...
func (m *ItemItemCheckSuitesItemCheckRunsGetResponse) SetCheckRuns(value []i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CheckRunable)() {
    m.check_runs = value
}
...
type ItemItemCheckSuitesItemCheckRunsGetResponseable interface {
    ...
    GetCheckRuns()([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CheckRunable)
    GetTotalCount()(*int32)
    SetCheckRuns(value []i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CheckRunable)()
