...
type ItemItemPagesPutRequestBody struct {
    ...
    // Specify a custom domain for the repository. Sending a `null` value will remove the custom domain. For more about custom domains, see "[Using a custom domain with GitHub Pages](https://docs.github.com/enterprise-cloud@latest//pages/configuring-a-custom-domain-for-your-github-pages-site)."
    cname *string
...
// GetPublic gets the public property value. Configures access controls for the GitHub Pages site. If public is set to `true`, the site is accessible to anyone on the internet. If set to `false`, the site will only be accessible to users who have at least `read` access to the repository that published the site. This includes anyone in your Enterprise if the repository is set to `internal` visibility.
// returns a *bool when successful
func (m *ItemItemPagesPutRequestBody) GetPublic()(*bool) {
    return m.public
}
...
// SetPublic sets the public property value. Configures access controls for the GitHub Pages site. If public is set to `true`, the site is accessible to anyone on the internet. If set to `false`, the site will only be accessible to users who have at least `read` access to the repository that published the site. This includes anyone in your Enterprise if the repository is set to `internal` visibility.
func (m *ItemItemPagesPutRequestBody) SetPublic(value *bool)() {
    m.public = value
}
