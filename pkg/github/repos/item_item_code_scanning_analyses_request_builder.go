...
import (
    ...
    ifc6b8c88c506adf62b2ae18f4ceb0ef34b36d8de3d6c1834ce032d2e515ebfb5 "github.com/octokit/go-sdk-enterprise-cloud/pkg/github/repos/item/item/codescanning/analyses"
)
...
type ItemItemCodeScanningAnalysesRequestBuilderGetQueryParameters struct {
    ...
    Direction *ifc6b8c88c506adf62b2ae18f4ceb0ef34b36d8de3d6c1834ce032d2e515ebfb5.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    Sort *ifc6b8c88c506adf62b2ae18f4ceb0ef34b36d8de3d6c1834ce032d2e515ebfb5.GetSortQueryParameterType `uriparametername:"sort"`
...
// ByAnalysis_id gets an item from the github.com/octokit/go-sdk-enterprise-cloud/pkg/github.repos.item.item.codeScanning.analyses.item collection
...
func (m *ItemItemCodeScanningAnalysesRequestBuilder) Get(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[ItemItemCodeScanningAnalysesRequestBuilderGetQueryParameters])([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CodeScanningAnalysisable, error) {
    ...
    errorMapping := i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.ErrorMappings {
        ...
        "503": i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CreateAnalyses503ErrorFromDiscriminatorValue,
    }
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CreateCodeScanningAnalysisFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CodeScanningAnalysisable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CodeScanningAnalysisable)
        }
    }
    return val, nil
}
