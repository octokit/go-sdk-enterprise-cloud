...
// ByRepo_owner gets an item from the github.com/octokit/go-sdk-enterprise-cloud/pkg/github.repos.item.item.codeScanning.codeql.variantAnalyses.item.repos.item collection
