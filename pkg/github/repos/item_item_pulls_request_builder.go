...
import (
    ...
    i776de166eff3f73b81126ffda958b4440483f3b3d5b1610f180bdd962dda86b3 "github.com/octokit/go-sdk-enterprise-cloud/pkg/github/repos/item/item/pulls"
)
...
type ItemItemPullsRequestBuilderGetQueryParameters struct {
    ...
    Direction *i776de166eff3f73b81126ffda958b4440483f3b3d5b1610f180bdd962dda86b3.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    Sort *i776de166eff3f73b81126ffda958b4440483f3b3d5b1610f180bdd962dda86b3.GetSortQueryParameterType `uriparametername:"sort"`
    // Either `open`, `closed`, or `all` to filter by state.
    State *i776de166eff3f73b81126ffda958b4440483f3b3d5b1610f180bdd962dda86b3.GetStateQueryParameterType `uriparametername:"state"`
}
// ByPull_number gets an item from the github.com/octokit/go-sdk-enterprise-cloud/pkg/github.repos.item.item.pulls.item collection
...
func (m *ItemItemPullsRequestBuilder) Post(ctx context.Context, body ItemItemPullsPostRequestBodyable, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.DefaultQueryParameters])(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.PullRequestable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.Send(ctx, requestInfo, i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CreatePullRequestFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    if res == nil {
    ...
    return res.(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.PullRequestable), nil
}
