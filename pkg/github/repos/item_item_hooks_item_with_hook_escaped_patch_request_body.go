...
type ItemItemHooksItemWithHook_PatchRequestBody struct {
    ...
    config i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.WebhookConfigable
...
func (m *ItemItemHooksItemWithHook_PatchRequestBody) GetConfig()(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.WebhookConfigable) {
    return m.config
}
...
func (m *ItemItemHooksItemWithHook_PatchRequestBody) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["config"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CreateWebhookConfigFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetConfig(val.(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.WebhookConfigable))
        }
        return nil
    }
...
func (m *ItemItemHooksItemWithHook_PatchRequestBody) SetConfig(value i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.WebhookConfigable)() {
    m.config = value
}
...
type ItemItemHooksItemWithHook_PatchRequestBodyable interface {
    ...
    GetActive()(*bool)
    GetAddEvents()([]string)
    GetConfig()(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.WebhookConfigable)
    GetEvents()([]string)
    GetRemoveEvents()([]string)
    SetActive(value *bool)()
    SetAddEvents(value []string)()
    SetConfig(value i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.WebhookConfigable)()
