...
type ItemItemCodespacesSecretsGetResponse struct {
    ...
    secrets []i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.RepoCodespacesSecretable
...
func (m *ItemItemCodespacesSecretsGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["secrets"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CreateRepoCodespacesSecretFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.RepoCodespacesSecretable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.RepoCodespacesSecretable)
                }
            }
            m.SetSecrets(res)
        }
...
func (m *ItemItemCodespacesSecretsGetResponse) GetSecrets()([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.RepoCodespacesSecretable) {
    return m.secrets
}
...
func (m *ItemItemCodespacesSecretsGetResponse) SetSecrets(value []i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.RepoCodespacesSecretable)() {
    m.secrets = value
}
...
type ItemItemCodespacesSecretsGetResponseable interface {
    ...
    GetSecrets()([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.RepoCodespacesSecretable)
    GetTotalCount()(*int32)
    SetSecrets(value []i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.RepoCodespacesSecretable)()
