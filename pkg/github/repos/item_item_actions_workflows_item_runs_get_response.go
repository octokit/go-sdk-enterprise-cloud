...
type ItemItemActionsWorkflowsItemRunsGetResponse struct {
    ...
    workflow_runs []i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.WorkflowRunable
}
...
func (m *ItemItemActionsWorkflowsItemRunsGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["workflow_runs"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CreateWorkflowRunFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.WorkflowRunable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.WorkflowRunable)
                }
            }
...
func (m *ItemItemActionsWorkflowsItemRunsGetResponse) GetWorkflowRuns()([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.WorkflowRunable) {
...
func (m *ItemItemActionsWorkflowsItemRunsGetResponse) SetWorkflowRuns(value []i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.WorkflowRunable)() {
...
type ItemItemActionsWorkflowsItemRunsGetResponseable interface {
    ...
    GetTotalCount()(*int32)
    GetWorkflowRuns()([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.WorkflowRunable)
    SetTotalCount(value *int32)()
    SetWorkflowRuns(value []i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.WorkflowRunable)()
}
