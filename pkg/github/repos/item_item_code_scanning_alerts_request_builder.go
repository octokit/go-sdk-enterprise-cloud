...
import (
    ...
    i22b9d1f4e45c0fc1fad5bfaaf80ebac6ec530ac932d0178961dadb608b770f0a "github.com/octokit/go-sdk-enterprise-cloud/pkg/github/repos/item/item/codescanning/alerts"
)
...
type ItemItemCodeScanningAlertsRequestBuilderGetQueryParameters struct {
    ...
    Sort *i22b9d1f4e45c0fc1fad5bfaaf80ebac6ec530ac932d0178961dadb608b770f0a.GetSortQueryParameterType `uriparametername:"sort"`
...
// ByAlert_number gets an item from the github.com/octokit/go-sdk-enterprise-cloud/pkg/github.repos.item.item.codeScanning.alerts.item collection
...
func (m *ItemItemCodeScanningAlertsRequestBuilder) Get(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[ItemItemCodeScanningAlertsRequestBuilderGetQueryParameters])([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CodeScanningAlertItemsable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CreateCodeScanningAlertItemsFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CodeScanningAlertItemsable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CodeScanningAlertItemsable)
        }
    }
    return val, nil
}
