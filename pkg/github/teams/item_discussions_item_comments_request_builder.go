...
import (
    ...
    iae2370292aad88fb026aab31bced866db9290855566de8f3b2d3e6b4330af70c "github.com/octokit/go-sdk-enterprise-cloud/pkg/github/teams/item/discussions/item/comments"
)
...
type ItemDiscussionsItemCommentsRequestBuilderGetQueryParameters struct {
    ...
    Direction *iae2370292aad88fb026aab31bced866db9290855566de8f3b2d3e6b4330af70c.GetDirectionQueryParameterType `uriparametername:"direction"`
    // The page number of the results to fetch. For more information, see "[Using pagination in the REST API](https://docs.github.com/enterprise-cloud@latest//rest/using-the-rest-api/using-pagination-in-the-rest-api)."
    Page *int32 `uriparametername:"page"`
    // The number of results per page (max 100). For more information, see "[Using pagination in the REST API](https://docs.github.com/enterprise-cloud@latest//rest/using-the-rest-api/using-pagination-in-the-rest-api)."
    Per_page *int32 `uriparametername:"per_page"`
}
// ByComment_number gets an item from the github.com/octokit/go-sdk-enterprise-cloud/pkg/github.teams.item.discussions.item.comments.item collection
// Deprecated: 
...
func (m *ItemDiscussionsItemCommentsRequestBuilder) Get(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[ItemDiscussionsItemCommentsRequestBuilderGetQueryParameters])([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.TeamDiscussionCommentable, error) {
