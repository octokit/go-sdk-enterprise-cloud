...
import (
    ...
    i36fc4ef1d6b81a809f590950bffaea825a8ede841666554e6532b4de87c79070 "github.com/octokit/go-sdk-enterprise-cloud/pkg/github/orgs/item/personalaccesstokenrequests"
)
...
type ItemPersonalAccessTokenRequestsRequestBuilderGetQueryParameters struct {
    ...
    Direction *i36fc4ef1d6b81a809f590950bffaea825a8ede841666554e6532b4de87c79070.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    Sort *i36fc4ef1d6b81a809f590950bffaea825a8ede841666554e6532b4de87c79070.GetSortQueryParameterType `uriparametername:"sort"`
}
// ByPat_request_id gets an item from the github.com/octokit/go-sdk-enterprise-cloud/pkg/github.orgs.item.personalAccessTokenRequests.item collection
...
func (m *ItemPersonalAccessTokenRequestsRequestBuilder) Get(ctx context.Context, requestConfiguration *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestConfiguration[ItemPersonalAccessTokenRequestsRequestBuilderGetQueryParameters])([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.OrganizationProgrammaticAccessGrantRequestable, error) {
    ...
    res, err := m.BaseRequestBuilder.RequestAdapter.SendCollection(ctx, requestInfo, i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CreateOrganizationProgrammaticAccessGrantRequestFromDiscriminatorValue, errorMapping)
    if err != nil {
        return nil, err
    }
    val := make([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.OrganizationProgrammaticAccessGrantRequestable, len(res))
    for i, v := range res {
        if v != nil {
            val[i] = v.(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.OrganizationProgrammaticAccessGrantRequestable)
        }
    }
    return val, nil
}
