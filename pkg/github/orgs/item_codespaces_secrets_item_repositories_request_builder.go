...
// ByRepository_id gets an item from the github.com/octokit/go-sdk-enterprise-cloud/pkg/github.orgs.item.codespaces.secrets.item.repositories.item collection
