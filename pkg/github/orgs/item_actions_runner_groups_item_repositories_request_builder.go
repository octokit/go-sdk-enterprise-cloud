...
// ByRepository_id gets an item from the github.com/octokit/go-sdk-enterprise-cloud/pkg/github.orgs.item.actions.runnerGroups.item.repositories.item collection
