...
type ItemSettingsNetworkConfigurationsGetResponse struct {
    ...
    network_configurations []i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.NetworkConfigurationable
...
func (m *ItemSettingsNetworkConfigurationsGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["network_configurations"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CreateNetworkConfigurationFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.NetworkConfigurationable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.NetworkConfigurationable)
                }
            }
...
func (m *ItemSettingsNetworkConfigurationsGetResponse) GetNetworkConfigurations()([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.NetworkConfigurationable) {
...
func (m *ItemSettingsNetworkConfigurationsGetResponse) SetNetworkConfigurations(value []i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.NetworkConfigurationable)() {
...
type ItemSettingsNetworkConfigurationsGetResponseable interface {
    ...
    GetNetworkConfigurations()([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.NetworkConfigurationable)
    GetTotalCount()(*int32)
    SetNetworkConfigurations(value []i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.NetworkConfigurationable)()
