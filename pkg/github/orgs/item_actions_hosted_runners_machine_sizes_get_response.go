...
type ItemActionsHostedRunnersMachineSizesGetResponse struct {
    ...
    machine_specs []i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.ActionsHostedRunnerMachineSpecable
...
func (m *ItemActionsHostedRunnersMachineSizesGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["machine_specs"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CreateActionsHostedRunnerMachineSpecFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.ActionsHostedRunnerMachineSpecable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.ActionsHostedRunnerMachineSpecable)
                }
            }
...
func (m *ItemActionsHostedRunnersMachineSizesGetResponse) GetMachineSpecs()([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.ActionsHostedRunnerMachineSpecable) {
...
func (m *ItemActionsHostedRunnersMachineSizesGetResponse) SetMachineSpecs(value []i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.ActionsHostedRunnerMachineSpecable)() {
...
type ItemActionsHostedRunnersMachineSizesGetResponseable interface {
    ...
    GetMachineSpecs()([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.ActionsHostedRunnerMachineSpecable)
    GetTotalCount()(*int32)
    SetMachineSpecs(value []i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.ActionsHostedRunnerMachineSpecable)()
