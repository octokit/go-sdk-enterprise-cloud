...
// GetSecretScanningValidityChecksEnabled gets the secret_scanning_validity_checks_enabled property value. Whether secret scanning automatic validity checks on supported partner tokens is enabled for all repositories under this organization.
// returns a *bool when successful
func (m *ItemWithOrgPatchRequestBody) GetSecretScanningValidityChecksEnabled()(*bool) {
...
// SetSecretScanningValidityChecksEnabled sets the secret_scanning_validity_checks_enabled property value. Whether secret scanning automatic validity checks on supported partner tokens is enabled for all repositories under this organization.
func (m *ItemWithOrgPatchRequestBody) SetSecretScanningValidityChecksEnabled(value *bool)() {
