...
type ItemPrivateRegistriesGetResponse struct {
    ...
    configurations []i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.OrgPrivateRegistryConfigurationable
...
func (m *ItemPrivateRegistriesGetResponse) GetConfigurations()([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.OrgPrivateRegistryConfigurationable) {
...
func (m *ItemPrivateRegistriesGetResponse) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["configurations"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.CreateOrgPrivateRegistryConfigurationFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.OrgPrivateRegistryConfigurationable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.OrgPrivateRegistryConfigurationable)
                }
            }
...
func (m *ItemPrivateRegistriesGetResponse) SetConfigurations(value []i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.OrgPrivateRegistryConfigurationable)() {
...
type ItemPrivateRegistriesGetResponseable interface {
    ...
    GetConfigurations()([]i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.OrgPrivateRegistryConfigurationable)
    GetTotalCount()(*int32)
    SetConfigurations(value []i65c45deea5ef786561f9cd3a81f83eacee03df1f39b7b57e269c7f0477b77b5d.OrgPrivateRegistryConfigurationable)()
