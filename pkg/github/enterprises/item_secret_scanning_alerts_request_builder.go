...
import (
    ...
    i0997a540be96230613e35afb4ef529cb044bc00ec923c719492c344368cd3161 "github.com/octokit/go-sdk-enterprise-cloud/pkg/github/enterprises/item/secretscanning/alerts"
)
...
type ItemSecretScanningAlertsRequestBuilderGetQueryParameters struct {
    ...
    Direction *i0997a540be96230613e35afb4ef529cb044bc00ec923c719492c344368cd3161.GetDirectionQueryParameterType `uriparametername:"direction"`
    ...
    // A comma-separated list of secret types to return. By default all secret types are returned.See "[Secret scanning patterns](https://docs.github.com/enterprise-cloud@latest//code-security/secret-scanning/secret-scanning-patterns#supported-secrets-for-advanced-security)"for a complete list of secret types.
    Secret_type *string `uriparametername:"secret_type"`
    // The property to sort the results by. `created` means when the alert was created. `updated` means when the alert was updated or resolved.
    Sort *i0997a540be96230613e35afb4ef529cb044bc00ec923c719492c344368cd3161.GetSortQueryParameterType `uriparametername:"sort"`
    // Set to `open` or `resolved` to only list secret scanning alerts in a specific state.
    State *i0997a540be96230613e35afb4ef529cb044bc00ec923c719492c344368cd3161.GetStateQueryParameterType `uriparametername:"state"`
