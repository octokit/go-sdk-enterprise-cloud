...
// ItemActionsHostedRunnersMachineSizesRequestBuilder builds and executes requests for operations under \enterprises\{enterprise}\actions\hosted-runners\machine-sizes
...
func NewItemActionsHostedRunnersMachineSizesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemActionsHostedRunnersMachineSizesRequestBuilder) {
    m := &ItemActionsHostedRunnersMachineSizesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/enterprises/{enterprise}/actions/hosted-runners/machine-sizes", pathParameters),
    }
    return m
}
...
// Get get the list of machine specs available for GitHub-hosted runners for an enterprise.
// returns a ItemActionsHostedRunnersMachineSizesGetResponseable when successful
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/actions/hosted-runners#get-github-hosted-runners-machine-specs-for-an-enterprise
...
// ToGetRequestInformation get the list of machine specs available for GitHub-hosted runners for an enterprise.
