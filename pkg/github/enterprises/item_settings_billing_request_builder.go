...
// CostCenters the costCenters property
// returns a *ItemSettingsBillingCostCentersRequestBuilder when successful
func (m *ItemSettingsBillingRequestBuilder) CostCenters()(*ItemSettingsBillingCostCentersRequestBuilder) {
    return NewItemSettingsBillingCostCentersRequestBuilderInternal(m.BaseRequestBuilder.PathParameters, m.BaseRequestBuilder.RequestAdapter)
}
