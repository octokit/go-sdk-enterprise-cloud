...
import (
    ...
    i41e2476475a26f38ed89062b68a0455faf84f257d0135d3deab8e569f3f23de9 "github.com/octokit/go-sdk-enterprise-cloud/pkg/github/enterprises/item/codescanning/alerts"
)
...
type ItemCodeScanningAlertsRequestBuilderGetQueryParameters struct {
    ...
    Direction *i41e2476475a26f38ed89062b68a0455faf84f257d0135d3deab8e569f3f23de9.GetDirectionQueryParameterType `uriparametername:"direction"`
    // The page number of the results to fetch. For more information, see "[Using pagination in the REST API](https://docs.github.com/enterprise-cloud@latest//rest/using-the-rest-api/using-pagination-in-the-rest-api)."
    Page *int32 `uriparametername:"page"`
    // The number of results per page (max 100). For more information, see "[Using pagination in the REST API](https://docs.github.com/enterprise-cloud@latest//rest/using-the-rest-api/using-pagination-in-the-rest-api)."
    Per_page *int32 `uriparametername:"per_page"`
    // The property by which to sort the results.
    Sort *i41e2476475a26f38ed89062b68a0455faf84f257d0135d3deab8e569f3f23de9.GetSortQueryParameterType `uriparametername:"sort"`
