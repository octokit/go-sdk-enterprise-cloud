...
import (
    ...
    i18fa73c4dd38e51cf42f90c845148dd429b7c7cf9cf7066839f38e3364ea235a "github.com/octokit/go-sdk-enterprise-cloud/pkg/github/enterprises/item/bypassrequests/pushrules"
)

// ItemBypassRequestsPushRulesRequestBuilder builds and executes requests for operations under \enterprises\{enterprise}\bypass-requests\push-rules
type ItemBypassRequestsPushRulesRequestBuilder struct {
    i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.BaseRequestBuilder
}
// ItemBypassRequestsPushRulesRequestBuilderGetQueryParameters lists the requests made by users of a repository to bypass push protection rules within an enterprise.
type ItemBypassRequestsPushRulesRequestBuilderGetQueryParameters struct {
    ...
    Request_status *i18fa73c4dd38e51cf42f90c845148dd429b7c7cf9cf7066839f38e3364ea235a.GetRequest_statusQueryParameterType `uriparametername:"request_status"`
    ...
    Time_period *i18fa73c4dd38e51cf42f90c845148dd429b7c7cf9cf7066839f38e3364ea235a.GetTime_periodQueryParameterType `uriparametername:"time_period"`
}
...
func NewItemBypassRequestsPushRulesRequestBuilderInternal(pathParameters map[string]string, requestAdapter i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.RequestAdapter)(*ItemBypassRequestsPushRulesRequestBuilder) {
    m := &ItemBypassRequestsPushRulesRequestBuilder{
        BaseRequestBuilder: *i2ae4187f7daee263371cb1c977df639813ab50ffa529013b7437480d1ec0158f.NewBaseRequestBuilder(requestAdapter, "{+baseurl}/enterprises/{enterprise}/bypass-requests/push-rules{?organization_name*,page*,per_page*,request_status*,requester*,reviewer*,time_period*}", pathParameters),
    }
    return m
}
...
// Get lists the requests made by users of a repository to bypass push protection rules within an enterprise.
// returns a []PushRuleBypassRequestable when successful
// returns a BasicError error when the service returns a 404 status code
// returns a BasicError error when the service returns a 500 status code
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/enterprise-admin/bypass-requests#list-push-rule-bypass-requests-within-an-enterprise
...
// ToGetRequestInformation lists the requests made by users of a repository to bypass push protection rules within an enterprise.
