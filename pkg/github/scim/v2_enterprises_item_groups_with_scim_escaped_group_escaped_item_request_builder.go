...
// Delete > [!NOTE]> SCIM provisioning using the REST API is in public beta and subject to change.Deletes a SCIM group from an enterprise.
...
// Get > [!NOTE]> SCIM provisioning for users and groups using the REST API is in public beta and subject to change.Gets information about a SCIM group.
...
// ToDeleteRequestInformation > [!NOTE]> SCIM provisioning using the REST API is in public beta and subject to change.Deletes a SCIM group from an enterprise.
...
// ToGetRequestInformation > [!NOTE]> SCIM provisioning for users and groups using the REST API is in public beta and subject to change.Gets information about a SCIM group.
// returns a *RequestInformation when successful
