...
type SecurityAndAnalysis struct {
    ...
    // The secret_scanning_validity_checks property
    secret_scanning_validity_checks SecurityAndAnalysis_secret_scanning_validity_checksable
}
...
func (m *SecurityAndAnalysis) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["secret_scanning_validity_checks"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateSecurityAndAnalysis_secret_scanning_validity_checksFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetSecretScanningValidityChecks(val.(SecurityAndAnalysis_secret_scanning_validity_checksable))
        }
        return nil
    }
    return res
...
// GetSecretScanningValidityChecks gets the secret_scanning_validity_checks property value. The secret_scanning_validity_checks property
// returns a SecurityAndAnalysis_secret_scanning_validity_checksable when successful
func (m *SecurityAndAnalysis) GetSecretScanningValidityChecks()(SecurityAndAnalysis_secret_scanning_validity_checksable) {
...
// SetSecretScanningValidityChecks sets the secret_scanning_validity_checks property value. The secret_scanning_validity_checks property
func (m *SecurityAndAnalysis) SetSecretScanningValidityChecks(value SecurityAndAnalysis_secret_scanning_validity_checksable)() {
...
type SecurityAndAnalysisable interface {
    ...
    GetSecretScanningValidityChecks()(SecurityAndAnalysis_secret_scanning_validity_checksable)
