...
// SecretScanningBypassRequest a bypass request made by a user asking to be exempted from push protection in this repository.
type SecretScanningBypassRequest struct {
    ...
    data []SecretScanningBypassRequest_dataable
    ...
    organization SecretScanningBypassRequest_organizationable
    // The repository the bypass request is for.
    repository SecretScanningBypassRequest_repositoryable
    // The type of request.
    request_type *string
    // The user who requested the bypass.
    requester SecretScanningBypassRequest_requesterable
    ...
    status *SecretScanningBypassRequest_status
    // The url property
    url *string
}
// NewSecretScanningBypassRequest instantiates a new SecretScanningBypassRequest and sets the default values.
func NewSecretScanningBypassRequest()(*SecretScanningBypassRequest) {
    m := &SecretScanningBypassRequest{
    }
    m.SetAdditionalData(make(map[string]any))
    return m
}
// CreateSecretScanningBypassRequestFromDiscriminatorValue creates a new instance of the appropriate class based on discriminator value
// returns a Parsable when successful
func CreateSecretScanningBypassRequestFromDiscriminatorValue(parseNode i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable, error) {
    return NewSecretScanningBypassRequest(), nil
}
// GetAdditionalData gets the AdditionalData property value. Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.
// returns a map[string]any when successful
func (m *SecretScanningBypassRequest) GetAdditionalData()(map[string]any) {
    return m.additionalData
}
// GetCreatedAt gets the created_at property value. The date and time the bypass request was created.
// returns a *Time when successful
func (m *SecretScanningBypassRequest) GetCreatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.created_at
}
// GetData gets the data property value. Data describing the push rules that are being requested to be bypassed.
// returns a []SecretScanningBypassRequest_dataable when successful
func (m *SecretScanningBypassRequest) GetData()([]SecretScanningBypassRequest_dataable) {
    return m.data
}
// GetExpiresAt gets the expires_at property value. The date and time the bypass request will expire.
// returns a *Time when successful
func (m *SecretScanningBypassRequest) GetExpiresAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time) {
    return m.expires_at
}
// GetFieldDeserializers the deserialization information for the current model
// returns a map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error) when successful
func (m *SecretScanningBypassRequest) GetFieldDeserializers()(map[string]func(i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode)(error)) {
    ...
    res["data"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetCollectionOfObjectValues(CreateSecretScanningBypassRequest_dataFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            res := make([]SecretScanningBypassRequest_dataable, len(val))
            for i, v := range val {
                if v != nil {
                    res[i] = v.(SecretScanningBypassRequest_dataable)
                }
            }
            m.SetData(res)
        }
    ...
    res["organization"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateSecretScanningBypassRequest_organizationFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetOrganization(val.(SecretScanningBypassRequest_organizationable))
        }
        return nil
    }
    res["repository"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateSecretScanningBypassRequest_repositoryFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetRepository(val.(SecretScanningBypassRequest_repositoryable))
        }
        return nil
    }
    ...
    res["requester"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetObjectValue(CreateSecretScanningBypassRequest_requesterFromDiscriminatorValue)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetRequester(val.(SecretScanningBypassRequest_requesterable))
        }
        return nil
    }
    ...
    res["status"] = func (n i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.ParseNode) error {
        val, err := n.GetEnumValue(ParseSecretScanningBypassRequest_status)
        if err != nil {
            return err
        }
        if val != nil {
            m.SetStatus(val.(*SecretScanningBypassRequest_status))
        }
        return nil
    }
...
// returns a SecretScanningBypassRequest_organizationable when successful
func (m *SecretScanningBypassRequest) GetOrganization()(SecretScanningBypassRequest_organizationable) {
    return m.organization
}
// GetRepository gets the repository property value. The repository the bypass request is for.
// returns a SecretScanningBypassRequest_repositoryable when successful
func (m *SecretScanningBypassRequest) GetRepository()(SecretScanningBypassRequest_repositoryable) {
    return m.repository
}
// GetRequester gets the requester property value. The user who requested the bypass.
// returns a SecretScanningBypassRequest_requesterable when successful
func (m *SecretScanningBypassRequest) GetRequester()(SecretScanningBypassRequest_requesterable) {
    return m.requester
}
...
// returns a *string when successful
func (m *SecretScanningBypassRequest) GetRequesterComment()(*string) {
    return m.requester_comment
}
// GetRequestType gets the request_type property value. The type of request.
// returns a *string when successful
func (m *SecretScanningBypassRequest) GetRequestType()(*string) {
...
// returns a *string when successful
func (m *SecretScanningBypassRequest) GetResourceIdentifier()(*string) {
...
func (m *SecretScanningBypassRequest) GetResponses()([]BypassResponseable) {
    return m.responses
}
// GetStatus gets the status property value. The status of the bypass request.
// returns a *SecretScanningBypassRequest_status when successful
func (m *SecretScanningBypassRequest) GetStatus()(*SecretScanningBypassRequest_status) {
    return m.status
}
// GetUrl gets the url property value. The url property
// returns a *string when successful
func (m *SecretScanningBypassRequest) GetUrl()(*string) {
    return m.url
}
// Serialize serializes information the current object
func (m *SecretScanningBypassRequest) Serialize(writer i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.SerializationWriter)(error) {
    {
...
func (m *SecretScanningBypassRequest) SetOrganization(value SecretScanningBypassRequest_organizationable)() {
    m.organization = value
}
// SetRepository sets the repository property value. The repository the bypass request is for.
func (m *SecretScanningBypassRequest) SetRepository(value SecretScanningBypassRequest_repositoryable)() {
    m.repository = value
}
// SetRequester sets the requester property value. The user who requested the bypass.
func (m *SecretScanningBypassRequest) SetRequester(value SecretScanningBypassRequest_requesterable)() {
    m.requester = value
}
...
func (m *SecretScanningBypassRequest) SetRequesterComment(value *string)() {
    m.requester_comment = value
}
// SetRequestType sets the request_type property value. The type of request.
func (m *SecretScanningBypassRequest) SetRequestType(value *string)() {
...
func (m *SecretScanningBypassRequest) SetResourceIdentifier(value *string)() {
    m.resource_identifier = value
}
// SetResponses sets the responses property value. The responses to the bypass request.
func (m *SecretScanningBypassRequest) SetResponses(value []BypassResponseable)() {
    m.responses = value
}
// SetStatus sets the status property value. The status of the bypass request.
func (m *SecretScanningBypassRequest) SetStatus(value *SecretScanningBypassRequest_status)() {
    m.status = value
}
// SetUrl sets the url property value. The url property
func (m *SecretScanningBypassRequest) SetUrl(value *string)() {
    m.url = value
}
type SecretScanningBypassRequestable interface {
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.AdditionalDataHolder
    i878a80d2330e89d26896388a3f487eef27b0a0e6c010c493bf80be1452208f91.Parsable
    GetCreatedAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)
    GetData()([]SecretScanningBypassRequest_dataable)
    GetExpiresAt()(*i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)
    GetHtmlUrl()(*string)
    GetId()(*int32)
    GetNumber()(*int32)
    GetOrganization()(SecretScanningBypassRequest_organizationable)
    GetRepository()(SecretScanningBypassRequest_repositoryable)
    GetRequester()(SecretScanningBypassRequest_requesterable)
    GetRequesterComment()(*string)
    GetRequestType()(*string)
    GetResourceIdentifier()(*string)
    GetResponses()([]BypassResponseable)
    GetStatus()(*SecretScanningBypassRequest_status)
    GetUrl()(*string)
    SetCreatedAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)()
    SetData(value []SecretScanningBypassRequest_dataable)()
    SetExpiresAt(value *i336074805fc853987abe6f7fe3ad97a6a6f3077a16391fec744f671a015fbd7e.Time)()
    SetHtmlUrl(value *string)()
    SetId(value *int32)()
    SetNumber(value *int32)()
    SetOrganization(value SecretScanningBypassRequest_organizationable)()
    SetRepository(value SecretScanningBypassRequest_repositoryable)()
    SetRequester(value SecretScanningBypassRequest_requesterable)()
    ...
    SetStatus(value *SecretScanningBypassRequest_status)()
    SetUrl(value *string)()
}
