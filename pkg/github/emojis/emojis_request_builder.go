...
// Get lists all the emojis available to use on GitHub Enterprise Cloud.
// returns a EmojisGetResponseable when successful
// [API method documentation]
// 
// [API method documentation]: https://docs.github.com/enterprise-cloud@latest//rest/emojis/emojis#get-emojis
...
// ToGetRequestInformation lists all the emojis available to use on GitHub Enterprise Cloud.
